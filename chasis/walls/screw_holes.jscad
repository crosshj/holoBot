...
var mountHoles = function(radius,height){
    return 
}

function wallmount(height,screwsOnly){
       var radius = 7.2/2;
       var radius2 = 4.15/2;
       var d1 = 10;
...
function main(params) {
   ...
   var showScrewsOnly = true;
   var mounts = union([
           wallmount(params.height,showScrewsOnly).translate([54,-49,0]),
           wallmount(params.height,showScrewsOnly).translate([54,49,0])
       ]);
